...
def create_3d_scatter(df,coeffs,deviations):
    ...
    scatter = go.Scatter3d(
        x=df['x'].values, # 2. Współrzędne X punktów - pobierane jako tablica numpy
        y=df['y'].values, # 3. Współrzędne y punktów - pobierane jako tablica numpy
        z=df['z'].values - c, # 4. Współrzędne z punktów - pobierane jako tablica numpy
